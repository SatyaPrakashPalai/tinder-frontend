...
function ProfileCard({ name, url, describ, loved, notInterested }) {
  ...
  return (
    <>
      <div className={styles.card}>
        <button className={styles.mail} onClick={handleLoved}>
          <svg
            fill="#000000"
            width="24"
            height="24"
            ...
            className={`${styles.lucide} ${styles.lucide_mail}`}
          >
        ...
        <div className={styles.bottom}>
          <div className={styles.content}>
            ...
            <span className={styles.about_me}>{describ} </span>
          </div>
          <div className={styles.bottom_bottom}>
            ...
            <button className={styles.button} onClick={handleNotInterested}>
              Not interested
            </button>
          </div>
        </div>
